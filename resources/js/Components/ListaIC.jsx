...
const ListaIC = () => {
    ...
    const arrayObjetos = [
        "citologicoVaginal",
        "hematologicoCompleto",
        "mqOrina",
        "citologicoEsputo",
        "citologicoBucal"
    ];
    
    const buscarEstudio = (nombreBuscar) => {
        return arrayObjetos.find(nombreBuscar) //! No creo que funcione
    }
    
  return (
    <div>{buscarEstudio()}</div>
  )
}

export default ListaIC